...
const LoginSidebar = () => {
    ...
    return (
        <>
            <div
                className={`login-sidebar fixed top-0 right-0 h-full overflow-y-scroll bg-white transition-all duration-500 z-20 sm:px-20 px-5 py-5 w-full sm:py-10 flex flex-col sm:w-[500px] ${isLoginSidebarOpen ? "translate-x-0" : "translate-x-full"}`}
            >
                ...
                <div className="relative left-0">
                    {!userDetails ? (
                        ...
                        <>
                            {userDetails?.name && (
                                <h2 className="font-ProximaNovaSemiBold text-2xl flex items-center">
                            ...
                            <div>
                                <p className="text-[#686b78] mt-2 font-ProximaNovaMed text-sm pr-5">
                                    Thank you for your time and patience. Come
                                    back soon !
                                </p>
                            </div>
                        </>
            ...
            <div
                className={`login-sidebar-overlay ${isLoginSidebarOpen ? "fixed" : "hidden"} z-10 top-0 left-0 right-0 bottom-0 bg-color-1 opacity-[0.7] overflow-hidden`}
            ></div>
        </>
    );
};
