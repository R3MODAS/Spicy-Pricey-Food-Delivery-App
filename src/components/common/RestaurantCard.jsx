            ...
            {opened ? (
                <>
                    <div className="flex flex-col gap-3 cursor-pointer">
                        ...
                        <div className="ml-3">
                            ...
                            <div className="font-GrotThin text-color-4 tracking-tight text-base">
                                {areaName}
                            </div>
                        </div>
                    </div>
                ...
                <>
                    <div className="flex flex-col gap-3 cursor-pointer">
                        <div className="w-80 h-56 card relative rounded-xl">
                            <img
                                src={RES_IMG_GRAY + cloudinaryImageId}
                                alt="res-img"
                                className="rounded-xl w-full h-full object-cover"
                            />
                        </div>
        ...
        return (
            <>
                ...
                {aggregatedDiscountInfoV2 && (
                    <label className="absolute bottom-28 left-3 text-white uppercase font-ProximaNovaBlack tracking-tighter text-[22px] label">
