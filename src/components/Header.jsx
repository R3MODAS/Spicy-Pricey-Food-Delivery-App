            ...
            <header className='shadow-md w-full fixed left-0 top-0 right-0 h-20 z-10 md:px-5 text-color-1 bg-white px-3'>
                <div className='flex justify-between items-center h-full container mx-auto'>
                    <div className='flex items-center md:gap-5 gap-2'>
                        ...
                        <button onClick={handleLocationSidebar} className='md:hidden flex gap-1 items-center text-color-1'>
                    ...
                    <ul className='font-ProximaNovaMed flex items-center lg:gap-16 md:gap-10 gap-4'>
                        <button onClick={handleLoginSidebar} className='flex items-center gap-2 group hover:text-color-2'>
                            <div>
                            ...
                            {
                                !userDetails ? <span className='md:inline hidden'>Sign In</span> : <span className='md:inline hidden'>{userDetails?.name}</span>
                            }
                        </button>
                        {
                            userDetails &&
