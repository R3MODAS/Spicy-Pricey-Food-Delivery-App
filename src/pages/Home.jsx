...

      {
        ...
        <>
          <section id='top-chain' className='relative'>
            <h2 className='font-GrotBlack text-2xl pb-5 pt-5'>Top restaurant chains in {userLocation?.city ? userLocation?.city : "Bangalore"}</h2>
            <div className="scroll-buttons absolute top-0 flex gap-2 right-10">
...

      {
        ...
        <>
          <section id='restaurants'>
            <h2 className='font-GrotBlack text-2xl pb-5 pt-5 2xl:text-start text-center sm:px-0 px-2'>Restaurants with online food delivery in {userLocation?.city ? userLocation?.city : "Bangalore"}</h2>
